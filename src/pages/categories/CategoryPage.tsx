  ...
  return (
    <div className="glass-card p-5 flex flex-col justify-between hover:border-amber-400/40 transition-colors">
      ...
      <div className="pt-3 border-t border-border/50 flex items-center justify-between gap-1.5">
        ...
        <Button asChild size="sm" variant="outline" className="font-mono text-xs h-7 border-border hover:border-amber-400 px-2.5">
          <Link to={`/agents/${agent.chainId}/${agent.tokenId}`}>Inspect</Link>
        </Button>
        <Button asChild size="sm" variant="outline" className="font-mono text-xs h-7 border-border hover:border-amber-400 px-2.5">
          <Link to={`/compare?ids=${agent.id}`}>Compare</Link>
        </Button>
      </div>
    </div>
  );
